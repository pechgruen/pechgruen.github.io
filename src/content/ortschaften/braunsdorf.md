...
<style>
  ...
  .braunsdorf-page figure.media {
    max-width: 780px;
    margin: 1.4rem 0 1.6rem 0; /* left aligned */
  }

  .braunsdorf-page figure.media img {
    width: 100%;
    height: auto;
    display: block; /* removes baseline gap under images */
  }

  .braunsdorf-page figure.media figcaption {
  ...
  .braunsdorf-page figure.media + p {
    margin-top: 0.9rem;
  }
</style>

<div class="braunsdorf-page">

<figure class="media">
  <img src="/images/braunsdorf-luftbild.jpg" alt="Braunsdorf – Luftbild der heutigen Situation">
  <figcaption>
...
<figure class="media">
  <img src="/images/braunsdorf-fabrik.jpg" alt="Porzellanfabrik in Chodau – Nachkriegszeit">
  <figcaption>
...
<figure class="media">
  <img src="/images/braunsdorf-haus.jpg" alt="Haus in Braunsdorf">
  <figcaption>
